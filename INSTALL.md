...
# 指定分支
pip install git+https://github.com/AISOP-AIGP-SoulBot/SoulBot.git@main

# 指定 tag
pip install git+https://github.com/AISOP-AIGP-SoulBot/SoulBot.git@v1.0.0
```

> 将 `AISOP-AIGP-SoulBot/SoulBot` 替换为实际的 GitHub 仓库路径。
...
# 指定分支
uvx --from git+https://github.com/AISOP-AIGP-SoulBot/SoulBot.git@main soulbot web --agents-dir .
```
...
# 从 GitHub 安装
pipx install git+https://github.com/AISOP-AIGP-SoulBot/SoulBot.git
