...
class AisopToolAnnotations(BaseModel):
    """Tool behavior annotations (AIGP v14 P2-1)."""
...
class AisopCapabilities(BaseModel):
    """Runtime capability declaration (AIGP v14 P2-3)."""
...
class AisopBlueprint(BaseModel):
    ...
    Attributes:
        ...
        registry_uri: Optional federated registry endpoint (AIGP v14 P2-2).
        capabilities: Runtime capability declaration (AIGP v14 P2-3).
        ui: UI component declarations (AIGP v14 P3-4).
        identity: Program identity verification (AIGP v13 P1-1).
    """
