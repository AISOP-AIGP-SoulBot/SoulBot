...
- **AIGP Package System** — Hot-pluggable capability packages (`*_aigp/`) with dynamic discovery and loading
...
[1.0.0]: https://github.com/AISOP-AIGP-SoulBot/SoulBot/releases/tag/v1.0.0
