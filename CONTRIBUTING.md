...
- Use [GitHub Issues](https://github.com/AISOP-AIGP-SoulBot/SoulBot/issues) to report bugs or suggest features
...
### AISOP / AIGP Contributions

Changes to AISOP blueprints (`.aisop.json`) or AIGP packages (`*_aigp/`) should:

- Follow the [AIGP Protocol](https://github.com/AISOP-AIGP-SoulBot/AIGP) specification
- Maintain deterministic execution paths in mermaid graphs
- Include governance metadata in `AIGP.md` for new packages
